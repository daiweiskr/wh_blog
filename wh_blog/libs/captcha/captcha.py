...
class Captcha:
    ...
    def initialize(self, width=200, height=75, color=None, text=None, fonts=None):
        self._text = text if text else ''.join(random.sample(string.ascii_uppercase + '3456789', 4))
    ...
    def warp(image, dx_factor=0.27, dy_factor=0.21):
        ...
        return image2.transform((width, height), Image.QUAD, (x1, y1, -x1, height2 - y2, width2 + x2, height2 + y2, width2 - x2, -y1))
